...
CONDA_DIR = '/home/luca_luis/anaconda3/envs/opennerf'
PREFIX = '/home/luca_luis/adl4cv/decoupled_3dseg/opennerf'
...
def eval_scene(scene, experiment_name):
    cmd = [f"{CONDA_DIR}/bin/python",
        f"{PREFIX}/datasets/opennerf_semantics.py",
        f"interpolate",
...
def eval_semantics(experiment_name):
    ...
    with open(os.path.join(PREFIX, f"metrics_opennerf"), 'w') as f:
