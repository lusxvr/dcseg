...
Source: OpenNeRF (https://github.com/opennerf/opennerf/blob/main/datasets/replica_preprocess.py)
"""
...
if __name__ == "__main__":
    parser = argparse.ArgumentParser(description="Preprocess Replica into the nerfstudio format.")
    parser.add_argument('--in_path', required=True, help="Downloaded and unziped path of Replica preprocessed by NICE-SLAM.")
    args = parser.parse_args()

    for scene in replica.scenes:
      data = f'{args.in_path}/{scene}'
      output_dir = f'{files.DATA_PATH}nerfstudio/replica_{scene}'
