...
def main():
    # with open('data/ScanNet/Tasks/Benchmark/scannetv2_train.txt','r') as f:
    #     train_split = f.readlines()
    # train_split = [s.strip()+'.txt' for s in train_split]

    # with open('data/ScanNet/Tasks/Benchmark/scannetv2_val.txt','r') as f:
    #     val_split = f.readlines()
    # val_split = [s.strip()+'.txt' for s in val_split]
    
    pred_files = ['scene0000_01.txt']
